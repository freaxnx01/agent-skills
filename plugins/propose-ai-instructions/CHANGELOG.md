...
- Exclude recipes with literal localhost ports from upstream proposals. Ports
  supplied through justfile or shell variables remain reusable.
- Make the Skill frontmatter valid YAML so Claude Code loads its metadata.
